        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 ml-auto mr-auto">
                    ...
                    <?php the_excerpt(); ?>
                    <hr>
					<?php get_template_part( 'template-parts/content', 'topauthor' ) ?>                    <?php the_content(); ?>
            ...
            <div class="row row-eq-height">
                <div class="col-md-6 d-flex">
                    <div class="story-action-boxes__box flex-grow-1">
                        ...
                        <?php
                        $btn_text = get_field('write_button_link');
                        if(!isset($btn_text)) : ?>
                        <p>
                            <a class="btn btn-lg btn-primary"
                               href="<?php the_field( 'write_button_link' ) ?>"><?php the_field('write_button_text')?>y</a>
                        </p>
                        <?php endif;?>
                    </div>
                </div>
                ...
                <div class="col-md-6 d-flex">
                    <div class="story-action-boxes__box alternative flex-grow-1">
                        <div class="small-label"><span><?php echo get_field( 'give_title' )?get_field( 'give_title' ):'Please give' ?></span><br>&nbsp;</div>
						<?php the_field( 'give_content' ) ?>
                        <p>
                            <a class="btn btn-lg btn-primary" href="<?php the_field( 'give_button_link' ) ?>"><?php the_field('give_button_text')?></a>
                        </p>
                    </div>
                </div>
            </div>
