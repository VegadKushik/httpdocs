...
<div id="DonateDetails">
    <section class="alternative-page donate-steps" role="document">
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <div class="donate-steps__form-wrapper">
						...
						require_once WP_PLUGIN_DIR . '/wp-multi-step-checkout-pro/includes/settings-array.php';
                        ...
                        <div class="wpmc-steps-wrapper">
                            ...
                            <div id="woocommerce_before_checkout_form" class="woocommerce_before_checkout_form"
                                 data-step="<?php echo apply_filters( 'woocommerce_before_checkout_form_step', 'step-review' ); ?>"
                                 style="display: none;">
                            ...
                            <form name="checkout" method="post" class="checkout woocommerce-checkout"
								...
								<?php foreach ( $steps as $_id => $_step ) {
									...
									echo '<div class="row"><div class="col-12"><div class="donate-steps__featured-image">';
									echo ' <img class="details-sideimg" src="'.get_stylesheet_directory_uri() . '/assets/images/dist/checkout/donate-details-placeholder.png" alt="Donate Details">';
									echo '</div>';
									echo '</div>';
									echo '<div class="col-12 px-md-5 px-3">';
